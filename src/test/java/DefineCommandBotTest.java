...
public class DefineCommandBotTest implements ChatContract.view {
    @Mock
    ...
    @Test
    @Order(2)
    void defineCommandBot() throws InterruptedException {
        ...
        Mockito.verify(chatContract).onDefineBotCommand(argument.capture());
